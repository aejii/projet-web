...
$creationuser = "INSERT INTO utilisateurs (`pseudo`,`empreinte`,`inscription`,`image`,`role` , `ipinscription`, `lienvalidation`, `email`, `resetmdp`) VALUES (:pseudo , :empreinte , :insciption , :image ,1, :ip, :lienvalidation, :email, :resetmdp )";
