...
<body>
    ...
    <div id="infos">
        ...
        <div id="scores">
            <!-- <score><strong>Click Damage : </strong><br/>Lv159 ~ 48773</score><button type="button" class="btn btn-upgrade"><img id="upgradeArrow" src="Images/upgradeArrow.png" /></button> Coût:296k <img id="tinyHeart" src="Images/heart.png"/><br/>
            <score><strong><abbr title="Your clics will inflict bonus damages, in proportion to total Waifu DPS ">Waifu link</abbr> :</strong><br/>Lv5 ~ 5% </score> <button type="button" class="btn btn-upgrade"><img id="upgradeArrow" src="Images/upgradeArrow.png" /></button> Coût:1M <img id="tinyHeart" src="Images/heart.png"/><br/> -->
            <div class="score"><strong>Dps Total : </strong>0</div>
    ...
    <div id="upgradePannel">
        ...
        <div id="upgrades1" class="tab-pane fade in active">
           ...
           <br/>
           <div id="waifu">
               <img class="waifuImage" src="Images/waifuKaori.png" /><div class="waifuName"> Kaori Miyazono </div><div class="waifuLevel">Lv.1</div>
           ...
           <br/>
           <div id="waifu">
               <img class="waifuImage" src="Images/waifuNakano.png" /><div class="waifuName"> Nakano Miku </div><div class="waifuLevel">Lv.1</div>
           ...
           <br/>
           <div id="waifu">
               <img class="waifuImage" src="Images/waifuErina.png" /><div class="waifuName"> Erina </div><div class="waifuLevel">Lv.1</div>
           ...
           <br/>
           <div id="waifu">
               <img class="waifuImage" src="Images/waifuChitoge.png" /><div class="waifuName"> Chitoge Kirisaki </div><div class="waifuLevel">Lv.1</div> 
           ...
           <br/>
           <div id="waifu">
               <img class="waifuImage" src="Images/waifuHikayu.jpg" /><div class="waifuName"> Hikayu </div><div class="waifuLevel">Lv.1</div> 
           ...
           <br/>
           <div id="waifu">
                <img class="waifuImage" src="Images/waifuTsugumi.png" /><div class="waifuName"> Tsugumi </div><div class="waifuLevel">Lv.1</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuFjorm.png" /><div class="waifuName"> Fjorm </div><div class="waifuLevel">Lv.1</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuAsuna.png" /><div class="waifuName"> Asuna </div><div class="waifuLevel">Lv.1</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuAlice.png" /><div class="waifuName"> Alice </div><div class="waifuLevel">Lv.1</div> 
            ...
            <br/>
            <div id="waifu">
               <img class="waifuImage" src="Images/waifuLyn.png" /><div class="waifuName"> Lyn </div><div class="waifuLevel">Lv.1</div> 
           ...
           <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuCynthia1.png" /><div class="waifuName"> Cynthia </div><div class="waifuLevel">Lv.1</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuHomura.png" /><div class="waifuName"> Homura Akemi </div><div class="waifuLevel">Lv.1</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuRemRam.png" /><div class="waifuName"> Rem&Ram </div><div class="waifuLevel">Lv.1</div> 
                <div class="damages">DPS: 0 (Suivant : +1B)</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuFuwa.png" /><div class="waifuName"> Fuwa Aika </div><div class="waifuLevel">Lv.1</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuTheresia.png" /><div class="waifuName"> Theresia Van Astrea </div><div class="waifuLevel">Lv.1</div> 
                <div class="damages">DPS: 0 (Suivant : +1B)</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuYurika.png" /><div class="waifuName"> Yurika Nijino </div><div class="waifuLevel">Lv.1</div> 
                <div class="damages">DPS: 0 (Suivant : +1B)</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuEmilia.png" /><div class="waifuName"> Emilia </div><div class="waifuLevel">Lv.1</div> 
                <div class="damages">DPS: 0 (Suivant : +1B)</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuTohru.png" /><div class="waifuName"> Tohru </div><div class="waifuLevel">Lv.1</div> 
                <div class="damages">DPS: 0 (Suivant : +1B)</div> 
            ...
            <br/>
            <div id="waifu">
                <img class="waifuImage" src="Images/waifuMegumin.png" /><div class="waifuName"> Megumin </div><div class="waifuLevel">Lv.1</div> 
                <div class="damages">DPS: 0 (Suivant : +1B)</div> 
        ...
        <div id="upgrades2" class="tab-pane fade">    
            ...
            <div id="aura">
                <img class="waifuImage" src="Images/iconNature.png" /><div class="waifuName"> Aura naturelle : Récolte </div><br/>
            ...
            <br/>
            <div id="aura">
                <img class="waifuImage" src="Images/iconWater.png" /><div class="waifuName"> Aura d'eau :  </div><br/>
                Effet : <br/>
                <button type="button" class="btn btn-lvlup">Débloquer</button> <button type="button" class="btn btn-lvlup">Choisir cette aura</button>
            </div>
            <br/>
            <div id="aura">
                <img class="waifuImage" src="Images/iconAir.png" /><div class="waifuName"> Aura de vent :  </div><br/>
                Effet : <br/>
                <button type="button" class="btn btn-lvlup">Débloquer</button> <button type="button" class="btn btn-lvlup">Choisir cette aura</button>
            </div>
            <br/>
            <div id="aura">
                <img class="waifuImage" src="Images/iconFire.png" /><div class="waifuName"> Aura de feu : Poings </div><br/>
                Effet : Augmente les dégats de clics de 15%<br/>
                <button type="button" class="btn btn-lvlup">Débloquer</button> <button type="button" class="btn btn-lvlup">Choisir cette aura</button>
            </div>
            <br/>
            <div id="aura">
                <img class="waifuImage" src="Images/iconMystic.png" /><div class="waifuName"> Aura mystique : </div><br/>
                Effet : <br/>
                <button type="button" class="btn btn-lvlup">Débloquer</button> <button type="button" class="btn btn-lvlup">Choisir cette aura</button>
            </div>
            <br/>
            <div id="aura">
                <img class="waifuImage" src="Images/iconStorm.png" /><div class="waifuName"> Aura de foudre : Chaîne d'éclairs </div><br/>
                Effet : <br/>
                <button type="button" class="btn btn-lvlup">Débloquer</button> <button type="button" class="btn btn-lvlup">Choisir cette aura</button>
            </div>
            <br/>
            <div id="aura">
                <img class="waifuImage" src="Images/iconIce.png" /><div class="waifuName"> Aura givrante : </div><br/>
                Effet :<br/>
                <button type="button" class="btn btn-lvlup">Débloquer</button> <button type="button" class="btn btn-lvlup">Choisir cette aura</button>
            </div>
            <br/>
            <div id="aura">
                <img class="waifuImage" src="Images/iconMagma.png" /><div class="waifuName"> Aura de magma : Furie </div><br/>
